...
intents = {
    "greetings": {
        ...
        "responses": ["Hello! How can I assist you?", "Hi there!", "Hey! What can I do for you?",
                      ...
                      "Good evening! How may I assist you?", "Hey there! How can I help?", "Hi! What's on your mind?",
    ...
    "weather": {
        "patterns": ["what's the weather like?", "weather forecast", "is it going to rain today?", "temperature today",
                     "weather report"],
        "responses": ["The weather today is [weather_description].",
                      "Currently, it's [temperature] degrees with [weather_description].",
                      "The forecast predicts [weather_forecast].", "It might rain today. Don't forget your umbrella!",
    ...
    "news": {
        ...
        "responses": ["Let me fetch the latest news for you.", "Here are the top headlines: [news_headlines]",
